...
- **AI:** xAI / Grok (see verification table). Currently stubbed by `mockInferLean` —
  real inference is the next build.
...
|---|---|---|---|---|
| Lean inference (chat) | `POST https://api.x.ai/v1/chat/completions` (OpenAI-compatible) | `grok-4.3` | https://docs.x.ai/docs/models | 2026-06-27 |
| Live web/X search (optional) | same endpoint, `search_parameters` / server-side search tools | n/a | https://docs.x.ai/docs/guides/live-search | 2026-06-27 |
