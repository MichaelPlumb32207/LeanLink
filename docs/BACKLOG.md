...
| ENH-001 | ✅ 2026-07-06 | P2 | Sunbiz index performance | Migration 015: composite `(snapshot_id, officer_name_norm)` over 20.6M rows. Officer lookups ~7 s (10 sequential shard scans) → **~53 ms**. County-scale step ⑤ unlocked. |
