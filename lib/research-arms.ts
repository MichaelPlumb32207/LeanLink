 ...
 * decide what each pass does. All are unassigned slots for now.
 */
...
export const RESEARCH_ARMS: ResearchArmPlaceholder[] = [
  { id: 't3a', label: 'T3a', title: 'Research pass A', description: 'Unassigned — to be defined.' },
  { id: 't3b', label: 'T3b', title: 'Research pass B', description: 'Unassigned — to be defined.' },
